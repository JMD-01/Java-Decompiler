...
class gui {
    ...
    public static void Create() {
        ...
        scan.addActionListener(new ActionListener() {
     	  ...
     	  public void actionPerformed(ActionEvent e) {            
     		  try {
     			  Decompile.DecompiledData.clear();
     			  textarea.setText("");
        ...
        //Search bar input
        JPasswordField searchbar = new JPasswordField(70); // accepts up to 70 characters
	  ...
	  public void actionPerformed(ActionEvent e) {            
		  ...
		  for(ArrayList<String> ScanSetting: Decompile.DecompiledData) {
    ...
    public static void LoginGUI() {
        ...
        frame.setResizable(false);
        //Failed auth text
        JLabel failedauth = new JLabel("");
        failedauth.setBounds(132, 60, 100, 10);
        frame.add(failedauth);
        //login code area
        logincode = new JPasswordField();   // accepts up to 70 characters
        logincode.setBounds(75, 25, 200, 23);
        logincode.setEditable(true);
        frame.add(logincode);
        //login button
        JButton LoginButton = new JButton("Login");
        LoginButton.setBounds(138, 80, 70, 25);
        LoginButton.addActionListener(new ActionListener() {
        	 	   
     	  public void actionPerformed(ActionEvent e) {            
     		  //Bypass code for searching strings yourself
     		  if(logincode.getText().equals("0000")) {
     			  Create();
     			  frame.setVisible(false);
     			  return;
     		  } else {
				//Failed auth
				failedauth.setText("INVALID CODE");
     		  }
     	  } 
