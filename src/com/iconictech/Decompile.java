...
public class Decompile {
	...
	public static ArrayList<ArrayList<String>> DecompiledData = new ArrayList<ArrayList<String>>();
	
    public static ArrayList<String> DecompileJar(String jarPath) throws IOException, IllegalAccessException, ClassNotFoundException {
    	// Your jar file
        ...
        while (entries.hasMoreElements()) {
            ...
            if (Entry.getName().endsWith(".class")) {
                ...
                DecompilerSettings settings = new DecompilerSettings().javaDefaults();
